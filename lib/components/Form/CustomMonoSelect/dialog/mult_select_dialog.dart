  ...
  Widget _buildListItem(MultiSelectItem<V> item) {
    return Theme(
      ...
      child: CheckboxListTile(
        ...
        value: _selectedValue == item.value,
        ...
        onChanged: (checked) {
          var newValue = widget.onItemCheckedChange(
              _selectedValue, item.value, checked);
  ...
  Widget _buildChipItem(MultiSelectItem<V> item) {
    return Container(
      ...
      child: ChoiceChip(
        ...
        selected: _selectedValue == item.value,
        onSelected: (checked) {
          setState(() {
            _selectedValue = widget.onItemCheckedChange(
                _selectedValue, item.value, checked)!;
          });
          if (widget.onSelectionChanged != null) {
            widget.onSelectionChanged!(_selectedValue!);
    ...
    return AlertDialog(
      ...
      title: widget.searchable == false
          ? Row(
              ...
              children: [
                Expanded(child: widget.title ?? Text("Select")),
                widget.clearText != null ?
                    TextButton(onPressed: (){
                      widget.onClearTap(context, widget.onConfirm);
                    }, child: widget.clearText!)
                    : Container()
              ],
            )
          : Container(
