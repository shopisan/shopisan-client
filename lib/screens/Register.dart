        ...
        children: [
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("assets/img/bg_login.jpg"),
                  fit: BoxFit.cover),
            ),
          ),
          Container(
              ...
              children: [
                ...
                Container(
                  ...
                  child: FlatButton(
                    onPressed: () {
                      Navigator.push(
                          context, MaterialPageRoute(builder: (_) => StoresScreen()));
                    },
                    child: Text(
                ...
                FlatButton(
                  ...
                  child: Text("Log In Here", style: GoogleFonts.roboto(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: CustomColors.textResearch,
                  ),),),
